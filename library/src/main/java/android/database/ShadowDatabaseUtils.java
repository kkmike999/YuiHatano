...
public class ShadowDatabaseUtils {
    private static final String TAG = "ShadowDatabaseUtils";
    ...
    private static int readExceptionCode(Parcel reply) {
        return (int) ReflectUtils.invoke(reply, "readExceptionCode");
    }
    ...
    public static final void readExceptionFromParcel(Parcel reply) {
        int code = readExceptionCode(reply);//reply.readExceptionCode();
        if (code == 0) return;
        String msg = reply.readString();
        ShadowDatabaseUtils.readExceptionFromParcel(reply, msg, code);
    }
    ...
    public static String sqlEscapeString(String value) {
        ...
        ShadowDatabaseUtils.appendEscapedSQLString(escaper, value);
     ...
     */
    public static long queryNumEntries(ShadowSQLiteDatabase db, String table) {
     ...
     */
    public static long queryNumEntries(ShadowSQLiteDatabase db, String table, String selection) {
     ...
     * @hide
     */
    public static boolean queryIsEmpty(ShadowSQLiteDatabase db, String table) {
     ...
     * </p>
     *
     * @deprecated Use {@link ShadowSQLiteStatement} instead.
     */
    @Deprecated
    public static class InsertHelper {
        ...
        /**
         * @param db        the ShadowSQLiteDatabase to insert into
         * @param tableName the name of the table to insert into
         */
        public InsertHelper(ShadowSQLiteDatabase db, String tableName) {
            mDb = db;
        ...
        private long insertInternal(ContentValues values, boolean allowReplace) {
            ...
            try {
                ...
                for (Map.Entry<String, Object> e : values.valueSet()) {
                    ...
                    ShadowDatabaseUtils.bindObjectToProgram(stmt, i, e.getValue());
                    if (DEBUG) {
...
//        ShadowSQLiteDatabase db = context.openOrCreateDatabase(dbName, 0, null);
