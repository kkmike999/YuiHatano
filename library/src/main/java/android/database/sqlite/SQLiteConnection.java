...
//        mIsReadOnlyConnection = (configuration.openFlags & ShadowSQLiteDatabase.OPEN_READONLY) != 0;
...
//        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
//            if ((mConfiguration.openFlags & ShadowSQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0) {
//                setJournalMode("WAL");
...
//        if ((mConfiguration.openFlags & ShadowSQLiteDatabase.NO_LOCALIZED_COLLATORS) != 0) {
//            return;
//        }
//
...
//                & ShadowSQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0;
...
//     */
//    public void prepare(String sql, ShadowSQLiteStatementInfo outStatementInfo) {
//        if (sql == null) {
...
//            switch (ShadowDatabaseUtils.getTypeOfObject(arg)) {
...
//        if (statementType == ShadowDatabaseUtils.STATEMENT_UPDATE
//                || statementType == ShadowDatabaseUtils.STATEMENT_SELECT) {
//            return true;
//        }
//        return false;
//    }
