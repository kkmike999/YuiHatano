 ...
 * <p>
 * <p>
 * ShadowSQLiteDatabase has methods to create, delete, execute SQL commands, and
...
public final class ShadowSQLiteDatabase extends SQLiteClosable {
    ...
    // INVARIANT: Immutable.
    private final ThreadLocal<ShadowSQLiteSession> mThreadSession = new ThreadLocal<ShadowSQLiteSession>() {
        @Override
        protected ShadowSQLiteSession initialValue() {
...
//        mErrorHandler.onCorruption(this);
    ...
    /**
     * Gets the {@link ShadowSQLiteSession} that belongs to this thread for this database.
     ...
     */
    ShadowSQLiteSession getThreadSession() {
...
//            return getThreadSession().hasTransaction();
    ...
    public static ShadowSQLiteDatabase openDatabase(String path, CursorFactory factory, int flags, DatabaseErrorHandler errorHandler) {
        ShadowSQLiteDatabase db = new ShadowSQLiteDatabase(path, flags, factory, errorHandler);
        db.open();
        return db;
    }
     ...
     */
    public static ShadowSQLiteDatabase openOrCreateDatabase(File file, CursorFactory factory) {
...
//    }
    ...
    public int getVersion() {
        return ((Long) ShadowDatabaseUtils.longForQuery(this, "PRAGMA user_version;", null)).intValue();
    }
    ...
    public long getMaximumSize() {
        long pageCount = ShadowDatabaseUtils.longForQuery(this, "PRAGMA max_page_count;", null);
    ...
    public long getPageSize() {
        return ShadowDatabaseUtils.longForQuery(this, "PRAGMA page_size;", null);
    }
...
//            String sql = "SELECT COUNT(*) AS c FROM sqlite_master WHERE type ='table' AND name ='" + table + "' ";
     ...
     * <code><pre>
     *     ShadowSQLiteDatabase db = ShadowSQLiteDatabase.openDatabase("db_filename", cursorFactory,
     *             ShadowSQLiteDatabase.CREATE_IF_NECESSARY | ShadowSQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING,
     ...
     * <code><pre>
     *     ShadowSQLiteDatabase db = ShadowSQLiteDatabase.openDatabase("db_filename", cursorFactory,
     *             ShadowSQLiteDatabase.CREATE_IF_NECESSARY, myDatabaseErrorHandler);
     *     db.enableWriteAheadLogging();
     * </pre></code>
     * </p><p>
    ...
    public String toString() {
        return "ShadowSQLiteDatabase: " + getPath();
    }
